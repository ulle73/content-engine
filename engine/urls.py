...
engine_urls = [
    ...
    path("sequences/<uuid:project_id>/plan/anchors/<int:position>/use-existing/", sequence_views.sequence_plan_anchor_use_existing, name="sequence_plan_anchor_use_existing"),
    path("sequences/<uuid:project_id>/plan/anchors/<int:position>/upload/", sequence_views.sequence_plan_anchor_upload, name="sequence_plan_anchor_upload"),
